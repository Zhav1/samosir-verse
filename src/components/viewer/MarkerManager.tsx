                    ...
                    markersPlugin.addMarker({
                        ...
                        html: `
                          <div class="group relative flex items-center justify-center" style="width: 100%; height: 100%; overflow: visible;">
                            ...
                            <!-- Floating Button (Muncul saat Hover group) -->
                            <div class="absolute bottom-full mb-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-[10px] group-hover:translate-y-0" style="pointer-events: auto;">
