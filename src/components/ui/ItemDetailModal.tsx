...
export default function ItemDetailModal() {
  const { currentLandmark, setCurrentLandmark } = useAppStore();
  
  // Kita bisa reuse state 'currentLandmark' atau buat state baru 'activeModal3D'
  // Untuk contoh ini, anggap kita check id-nya
  const isOpen = currentLandmark?.id === 'hasapi-object'; 
      ...
      >
        <div className="relative w-full max-w-4xl h-[80vh] bg-gray-900/50 rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
          ...
          <div className="absolute top-4 right-4 z-10">
            <button 
              onClick={() => setCurrentLandmark(null)}
