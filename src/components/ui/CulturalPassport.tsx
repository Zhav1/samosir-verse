...
import {
    X, Book, Stamp, ChevronLeft, ChevronRight,
    Sparkles, Lock
} from 'lucide-react';
import { useAppStore } from '@/store/useAppStore';
import { CATEGORIES, CATEGORY_COLORS, Category } from '@/lib/constants';

// Landmark data organized by category for stamp display
...
export function CulturalPassport({ isOpen, onClose }: CulturalPassportProps) {
    ...
    const categoryLandmarks = LANDMARKS_BY_CATEGORY[currentCategory];
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-4 sm:inset-auto sm:top-1/2 sm:left-1/2 
                                   sm:-translate-x-1/2 sm:-translate-y-1/2
                                   sm:w-[500px] sm:h-[600px]
                                   bg-gradient-to-br from-amber-800 to-amber-950
                                   rounded-xl shadow-2xl z-[71]
