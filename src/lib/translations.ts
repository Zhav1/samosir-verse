...
export const translations = {
  ...
  npc: {
    ...
    poweredBy: {
      en: 'Powered by Samosir-360 • Cultural heritage of Samosir Island',
      id: 'Didukung oleh Samosir-360 • Warisan budaya Pulau Samosir',
      bt: 'Diurupi Samosir-360 • Tona budaya Pulo Samosir',
    },
  },
  itemDetail: {
    dragRotate: {
